...
const imageSources = [fondo1, fondo2, fondo3, fondo4, fondo5, fondo6, fondo7, fondo8, fondo9, fondo10];
function Home() {
    ...
    return (
        <div>
            <div className="myDiv" style={{ backgroundImage: `url(${currentImage})` }}>
            </div>
            <p className="scroll-text" style={{
            }}>
                {"@HERBIVORO SIMÓN DE ZUBIRÍA RESTREPO @HERBIVORO SIMÓN DE ZUBIRÍA RESTREPO @HERBIVORO SIMÓN DE ZUBIRÍA RESTREPO @HERBIVORO SIMÓN DE ZUBIRÍA RESTREPO @HERBIVORO SIMÓN DE ZUBIRÍA RESTREPO @HERBIVORO SIMÓN DE ZUBIRÍA RESTREPO         @HERBIVORO SIMÓN DE ZUBIRÍA RESTREPO @HERBIVORO SIMÓN DE ZUBIRÍA RESTREPO @HERBIVORO SIMÓN DE ZUBIRÍA RESTREPO @HERBIVORO SIMÓN DE ZUBIRÍA RESTREPO @HERBIVORO SIMÓN DE ZUBIRÍA RESTREPO @HERBIVORO SIMÓN DE ZUBIRÍA RESTREPO"}      </p>
